...
@interface HsPlistBrowerNode : NSObject <NSCopying>
...
@property (nonatomic, nullable, weak, readonly) HsPlistBrowerNode *parent;
...
/// 字典或数组的元素数组
@property (nonatomic, strong) NSMutableArray<HsPlistBrowerNode *> *children;
