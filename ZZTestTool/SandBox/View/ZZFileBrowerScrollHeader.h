...
@class ZZFileBrowerScrollHeader;

@protocol ZZFileBrowerScrollHeaderDelegate <NSObject>
...
@interface ZZFileBrowerScrollHeader : UIView
...
@property (nonatomic, nullable, weak) id<ZZFileBrowerScrollHeaderDelegate> delegate;
