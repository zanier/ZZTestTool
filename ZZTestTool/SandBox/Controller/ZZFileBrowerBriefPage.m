...
@interface ZZFileBrowerBriefPage () <UITableViewDataSource, UITableViewDelegate> {
...
@implementation ZZFileBrowerBriefPage

/// MARK: - init

+ (id)createPage:(NSDictionary *)params {
    ZZFileBrowerBriefPage *page = [[ZZFileBrowerBriefPage alloc] init];
    return page;
}
...
static NSString *const ZZFileBrowerBriefCell_Type = @"种类";
static NSString *const ZZFileBrowerBriefCell_Size = @"大小";
static NSString *const ZZFileBrowerBriefCell_CreateDate = @"创建时间";
static NSString *const ZZFileBrowerBriefCell_ModifyDate = @"修改时间";
static NSString *const ZZFileBrowerBriefCell_LastOpenDate = @"上次打开时间";
static NSString *const ZZFileBrowerBriefCell_Location = @"位置";
...
- (void)viewDidLoad {
    ...
    _dataSource = @[
        ZZFileBrowerBriefCell_Type,
        ZZFileBrowerBriefCell_Size,
        ZZFileBrowerBriefCell_CreateDate,
        ZZFileBrowerBriefCell_ModifyDate,
        ZZFileBrowerBriefCell_LastOpenDate,
        ZZFileBrowerBriefCell_Location,
    ];
...
- (void)setupItem {
    _headerImageView.image = [ZZFileBrowerManager imageWithFileType:_item.type scale:3];
...
- (void)setupCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([ZZFileBrowerBriefCell_Type isEqualToString:title]) {
        cell.detailTextLabel.text = _item.extension;
    } else if ([ZZFileBrowerBriefCell_Size isEqualToString:title]) {
        cell.detailTextLabel.text = _item.sizeString;
    } else if ([ZZFileBrowerBriefCell_CreateDate isEqualToString:title]) {
        cell.detailTextLabel.text = _item.createDateString;
    } else if ([ZZFileBrowerBriefCell_ModifyDate isEqualToString:title]) {
        cell.detailTextLabel.text = _item.modifyDateString;
    } else if ([ZZFileBrowerBriefCell_LastOpenDate isEqualToString:title]) {
        cell.detailTextLabel.text = _item.lastOpenDateString;
    } else if ([ZZFileBrowerBriefCell_Location isEqualToString:title]) {
