...
#import "ZZConfigBrowerPage.h"
#import "ZZTestToolDefine.h"
#import "ZZConfigBrowerPlistPage.h"
#import "ZZConfigBrowerHeaderView.h"

@interface ZZConfigBrowerPage () <UIPageViewControllerDataSource, UIPageViewControllerDelegate>

@property (nonatomic, strong) UIPageViewController *pageViewController;

@property (nonatomic, strong) UIToolbar *headerToolBar; // 顶部滑动父视图
@property (nonatomic, strong) UISearchBar *searchBar;
@property (nonatomic, strong) ZZConfigBrowerHeaderView *headerView;

@end

@implementation ZZConfigBrowerPage
...
- (ZZConfigBrowerHeaderView *)headerView {
    if (!_headerView) {
        _headerView = [ZZConfigBrowerHeaderView viewWithextArray:nil];
